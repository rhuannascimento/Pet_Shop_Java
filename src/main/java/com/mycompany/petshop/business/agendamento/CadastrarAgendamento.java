...
public class CadastrarAgendamento {
    public CadastrarAgendamento(int id, Timestamp data_hora, Animal animal, Servico servico) throws AgendamentoExp{
        ...
        if(!lista1.isEmpty() && !lista2.isEmpty()){
            throw new AgendamentoExp("Horario ja reservado!");
        }else{
            ar.insertOne(a);
        }
