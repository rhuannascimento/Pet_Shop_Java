...
public class PETSHOP {
    ...
    public static void main(String[] args) {
        ...
        if(bmigrate) System.out.println(ANSI_GREEN+"MIGRAÇÃO: CONCLUÍDA!"); else System.out.println(ANSI_RED+"MIGRAÇÃO: NÃO EXECUTADO!");
        if(bmigrate) System.out.println(ANSI_GREEN+"SEED: CONCLUÍDA!"); else System.out.println(ANSI_RED+"SEED: NÃO EXECUTADO!");
        if(bmigrate) System.out.println(ANSI_GREEN+"TESTE: CONCLUÍDA!"); else System.out.println(ANSI_RED+"TESTE: NÃO EXECUTADO!");
    ...
    static boolean testar(){
        ...
        try{
            ...
            if(lista.size() == 0) System.out.println(ANSI_PURPLE+"Não existe funcionário com esse username!"+ANSI_RESET);
            else System.out.println(ANSI_PURPLE+"Existe funcionário com esse username!"+ANSI_RESET);
            ...
            Servico s2 = null;
            if(a2s.getTipo().equalsIgnoreCase("servico")) s2 = (Servico) a2s;
